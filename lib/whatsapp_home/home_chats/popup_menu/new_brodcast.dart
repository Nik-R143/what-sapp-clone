...
class Newbrodcast extends StatelessWidget {
    ...
    return Scaffold(
      appBar: AppBar(
        title:Column(
          ...
          children: <Widget>[
            Text('New broadcast'),
            Visibility(visible: true,child: Text('0 of 10 selected',style: TextStyle(fontSize: 12.0),),),
          ],),
        actions: [
      ...
      body:SingleChildScrollView(
        child: Column(
          children: [
        ListTile(
        title: Text('Only contacts with +917719977524 in their address book will receive your broadcast messages.',style: TextStyle(color: Colors.grey),),
        ),
          Divider(),
          ListView.builder(
            shrinkWrap: true,
